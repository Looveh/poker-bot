...
import se.cygni.texasholdem.communication.message.event.PlayerBetBigBlindEvent;
import se.cygni.texasholdem.communication.message.event.PlayerBetSmallBlindEvent;
...
import se.cygni.texasholdem.communication.message.event.TableChangedStateEvent;
...
public class FullyImplementedBot implements Player {
    ...
    public String getName() {
      return "Jag-vill-att-du-ska-pokera-mig";
    }
